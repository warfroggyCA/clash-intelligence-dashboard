      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Home Clan Management</h3>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Clan Switching</h3>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm text-gray-600">
              Theme customization, font size, and display preferences coming soon.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm text-gray-600">
              Notification preferences and alerts coming soon.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm text-gray-600">
              Data export, import, and backup options coming soon.
            </p>
          </div>
        </div>
